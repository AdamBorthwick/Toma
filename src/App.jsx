...
const SHELVES = [
  {
    ...
    items: [
      { type: 'book', ...book('dracula', 'Dracula', 'Bram Stoker', '#1c1c1c', '#d94f3d', 150, 30, '#1c1c1c', '#f4ede0', 'A Transylvanian count, a trail of letters, and a creeping dread that has never quite left the genre.'), thumbnail: '/covers/dracula.jpg', year: '1897' },
      { type: 'book', ...book('sherlock', 'Sherlock Holmes', 'A. C. Doyle', '#c9b184', '#1C1C2E', 158, 32, '#c9b184', '#1C1C2E', 'The world\'s most famous detective and twelve cases that made deduction look like magic.'), thumbnail: '/covers/sherlock.jpg', year: '1892' },
      { type: 'book', ...book('animalfarm', 'Animal Farm', 'George Orwell', '#7d1f1f', '#f4ede0', 142, 26, '#7d1f1f', '#f4ede0', 'All animals are equal—until a fable about a farmyard revolution proves some are more equal than others.'), thumbnail: '/covers/animalfarm.jpg', year: '1945' },
      { type: 'book', ...book('journey', 'Journey to the Centre of the Earth', 'Jules Verne', '#bcd9e0', '#234a52', 168, 30, '#bcd9e0', '#234a52', 'Down a volcano and into the impossible—Verne\'s grand subterranean expedition.'), thumbnail: '/covers/journey.jpg', year: '1864' },
      { type: 'book', ...book('mockingbird', 'To Kill a Mockingbird', 'Harper Lee', '#2f7d6e', '#f4ede0', 162, 34, '#2f7d6e', '#f4ede0', 'A small Southern town, a wrongful trial, and a childhood that learns what courage costs.'), thumbnail: '/covers/mockingbird.jpg', year: '1960' },
      { type: 'stack', id: 'classics-stack', books: [
        { ...book('littlewomen', 'Little Women', 'L. M. Alcott', '#ece3cf', '#7a3a6e', 26, 232, '#ece3cf', '#7a3a6e', 'Four March sisters grow up amid love, loss and ambition in Civil-War New England.'), thumbnail: '/covers/littlewomen.jpg', year: '1868' },
        { ...book('twocities', 'A Tale of Two Cities', 'Charles Dickens', '#e9dfc6', '#9a2f2f', 26, 232, '#e9dfc6', '#9a2f2f', 'London and Paris, sacrifice and resurrection, in Dickens\' great novel of revolution.'), thumbnail: '/covers/twocities.jpg', year: '1859' },
        { ...book('mobydick', 'Moby Dick', 'Herman Melville', '#1b1b1b', '#7fb8d6', 30, 232, '#1b1b1b', '#7fb8d6', 'One captain\'s obsession with a white whale becomes literature\'s deepest dive.'), thumbnail: '/covers/mobydick.jpg', year: '1851' },
      ] },
    ],
  },
  {
    ...
    items: [
      { type: 'book', ...book('got', 'A Game of Thrones', 'G. R. R. Martin', '#161616', '#e8e8e8', 168, 32, '#161616', '#e8e8e8', 'Winter is coming—and so are the schemes of every house clawing toward the Iron Throne.'), thumbnail: '/covers/got.jpg', year: '1996' },
      { type: 'book', ...book('namewind', 'The Name of the Wind', 'Patrick Rothfuss', '#1f3a5f', '#dfe7ef', 162, 30, '#1f3a5f', '#dfe7ef', 'A gifted, haunted young man tells the story of how legend and ruin became the same thing.'), thumbnail: '/covers/namewind.jpg', year: '2007' },
      { type: 'book', ...book('poppywar', 'The Poppy War', 'R. F. Kuang', '#5a1a1a', '#e8a23d', 150, 28, '#5a1a1a', '#e8a23d', 'A war orphan claws into an elite academy and discovers a terrible, godlike power.'), thumbnail: '/covers/poppywar.jpg', year: '2018' },
      { type: 'book', ...book('fellowship', 'The Fellowship of the Ring', 'J. R. R. Tolkien', '#efe6cf', '#5a3210', 170, 32, '#efe6cf', '#5a3210', 'One ring, nine companions, and the long road that begins all modern fantasy.'), thumbnail: '/covers/fellowship.jpg', year: '1954' },
      { type: 'stack', id: 'fantasy-stack', books: [
        { ...book('dragonreborn', 'The Dragon Reborn', 'Robert Jordan', '#103022', '#d9b860', 24, 250, '#103022', '#d9b860', 'The Wheel turns and a reluctant hero edges closer to a prophecy he can\'t outrun.'), thumbnail: '/covers/dragonreborn.jpg', year: '1991' },
        { ...book('fourthwing', 'Fourth Wing', 'Rebecca Yarros', '#d9cdb6', '#5a3a1a', 24, 250, '#d9cdb6', '#5a3a1a', 'Bond with a dragon or die trying—war college has never been this lethal.'), thumbnail: '/covers/fourthwing.jpg', year: '2023' },
        { ...book('hp', 'Harry Potter & the Sorcerer\'s Stone', 'J. K. Rowling', '#0d1b3a', '#e8b84b', 24, 250, '#0d1b3a', '#e8b84b', 'A boy learns he\'s a wizard and steps through the wall into a hidden world.'), thumbnail: '/covers/hp.jpg', year: '1997' },
        { ...book('finalempire', 'The Final Empire', 'Brandon Sanderson', '#cfe0ee', '#1c3a52', 28, 250, '#cfe0ee', '#1c3a52', 'In a world of ash and mist, a street thief learns to swallow metal and move mountains.'), thumbnail: '/covers/finalempire.jpg', year: '2006' },
      ] },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'stack', id: 'scifi-stack', books: [
        { ...book('redrising', 'Red Rising', 'Pierce Brown', '#161616', '#d94f3d', 24, 240, '#161616', '#d94f3d', 'A lowborn miner infiltrates the gilded elite to burn their society down from inside.'), thumbnail: '/covers/redrising.jpg', year: '2014' },
        { ...book('f451', 'Fahrenheit 451', 'Ray Bradbury', '#e74c3c', '#1c1c1c', 24, 240, '#e74c3c', '#1c1c1c', 'A fireman whose job is burning books begins, dangerously, to read them.'), thumbnail: '/covers/f451.jpg', year: '1953' },
        { ...book('axiom', 'Axiom\'s End', 'Lindsay Ellis', '#161616', '#d94f3d', 24, 240, '#161616', '#d94f3d', 'First contact arrives messy, political and far stranger than the movies promised.'), thumbnail: '/covers/axiom.jpg', year: '2020' },
      ] },
      { type: 'book', ...book('dune', 'Dune', 'Frank Herbert', '#0a0a0a', '#e8a23d', 168, 32, '#0a0a0a', '#e8a23d', 'Spice, sandworms and a desert messiah—the epic that defined science fiction.'), thumbnail: '/covers/dune.jpg', year: '1965' },
      { type: 'book', ...book('frankenstein', 'Frankenstein', 'Mary Shelley', '#6b1414', '#e8ddc8', 158, 28, '#6b1414', '#e8ddc8', 'A scientist gives life to a creature—and learns too late what he owes it.'), thumbnail: '/covers/frankenstein.jpg', year: '1818' },
      { type: 'book', ...book('martian', 'The Martian', 'Andy Weir', '#b23b2e', '#f4ede0', 164, 30, '#b23b2e', '#f4ede0', 'Stranded on Mars with duct tape and stubbornness, one astronaut science-es his way home.'), thumbnail: '/covers/martian.jpg', year: '2011' },
      { type: 'book', ...book('2001', '2001: A Space Odyssey', 'Arthur C. Clarke', '#1b1b1b', '#e8c84b', 170, 28, '#1b1b1b', '#e8c84b', 'A black monolith nudges humanity from the bone to the stars—and beyond.'), thumbnail: '/covers/2001.jpg', year: '1968' },
      { type: 'book', ...book('phm', 'Project Hail Mary', 'Andy Weir', '#0e1a3a', '#5fc8e0', 156, 30, '#0e1a3a', '#5fc8e0', 'A lone amnesiac wakes light-years from home as Earth\'s last, unlikely hope.'), thumbnail: '/covers/phm.jpg', year: '2021' },
    ],
  },
  {
    label: 'Mystery', accent: '#8E5BB5', tabBg: '#B98AD6', tabInk: '#3d2354',
    items: [
      { type: 'book', ...book('gonegirl', 'Gone Girl', 'Gillian Flynn', '#e9e2d0', '#b8302a', 150, 28, '#e9e2d0', '#b8302a', 'A wife vanishes on her anniversary, and every clue makes her husband look guiltier.'), thumbnail: '/covers/gonegirl.jpg', year: '2012' },
      { type: 'book', ...book('dragontattoo', 'The Girl with the Dragon Tattoo', 'Stieg Larsson', '#161616', '#e8a23d', 168, 30, '#161616', '#e8a23d', 'A disgraced journalist and a feral hacker dig into a family\'s decades-old disappearance.'), thumbnail: '/covers/dragontattoo.jpg', year: '2005' },
      { type: 'book', ...book('andthen', 'And Then There Were None', 'Agatha Christie', '#1a3a2e', '#e8ddc8', 160, 28, '#1a3a2e', '#e8ddc8', 'Ten strangers, one island, and a nursery rhyme that keeps coming true.'), thumbnail: '/covers/andthen.jpg', year: '1939' },
      { type: 'book', ...book('silentpatient', 'The Silent Patient', 'Alex Michaelides', '#2a5a8a', '#f0e8d8', 156, 30, '#2a5a8a', '#f0e8d8', 'She shot her husband, then never spoke again. One therapist is sure he can reach her.'), thumbnail: '/covers/silentpatient.jpg', year: '2019' },
      { type: 'stack', id: 'mystery-stack', books: [
        { ...book('rebecca', 'Rebecca', 'Daphne du Maurier', '#3a2a4a', '#d9b860', 26, 240, '#3a2a4a', '#d9b860', 'A new bride is haunted by the memory of the first Mrs de Winter at Manderley.'), thumbnail: '/covers/rebecca.jpg', year: '1938' },
        { ...book('davinci', 'The Da Vinci Code', 'Dan Brown', '#161616', '#b8302a', 26, 240, '#161616', '#b8302a', 'A murder in the Louvre unspools a centuries-old secret hidden in plain sight.'), thumbnail: '/covers/davinci.jpg', year: '2003' },
      ] },
