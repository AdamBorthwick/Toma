...
import { MonsterAccessoryGraphic } from './accessories.jsx'
import { MonsterEyes } from './eyes.jsx'

// â”€â”€â”€ Scene pieces â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    ...
    >
      <div style={{
        ...
        background: b.spine, borderRadius: '3px 3px 2px 2px', overflow: 'hidden',
        boxShadow: active
        ...
        <SpineLabel axis="vertical" title={b.title} dims={{ w: b.w, h: b.h }} ink={b.ink} />
      </div>
    </div>
  )
}
  ...
  return (
    ...
    >
      <div style={{
        ...
        <SpineLabel axis="horizontal" title={b.title} dims={{ w: b.w, h: b.h }} ink={b.ink} />
      </div>
    </div>
  )
}
function CaveBackground({ stageHeight, bookcaseBottom }) {
  ...
  return (
    <>
      ...
      >
      {/* ΓöÇΓöÇ Cave ceiling ΓÇö layered rock strata, mostly flat with organic drops ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Stalactites (ceiling, left cluster) ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Stalactites (ceiling, right cluster) ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Water drips from stalactite tips ΓöÇΓöÇ */}
      {(() => {
        ...
        return drips.flatMap(([cx, cy, r, cycle, delay]) => {
          ...
          return [
            ...
            // splash droplets ΓÇö water crown pattern
...
// ΓöÇΓöÇΓöÇ PoofSmoke ΓÇö cartoon SVG smoke cloud that covers the bookshelf ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

function PoofSmoke({ top, h }) {
  const W = 624
  // Merged into one shape via SVG filter ΓÇö single animation instead of 13
  const circles = [
...
// ΓöÇΓöÇΓöÇ TomaHead ΓÇö inline SVG so irises can be driven by React state ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
